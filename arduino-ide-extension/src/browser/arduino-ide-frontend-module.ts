...
import {
  ...
  BoardSelectToolProvider,
  LibrarySearchToolProvider,
  LibraryInstallToolProvider,
  SketchCreateToolProvider,
  SketchReadToolProvider,
  CompileToolProvider,
  UploadToolProvider,
  SerialMonitorToolProvider,
  LibraryUninstallToolProvider,
  BoardManagerInstallToolProvider,
  FileExplorerToolProvider,
  CodeEditToolProvider,
} from './ai/arduino-tools';
...
export default new ContainerModule((bind, unbind, isBound, rebind) => {
  ...
  // --- AI Agent: Kilo Gateway + Arduino Tools ---
  ...
  bind(BoardSelectToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(BoardSelectToolProvider);
  bind(LibrarySearchToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(LibrarySearchToolProvider);
  bind(LibraryInstallToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(LibraryInstallToolProvider);
  bind(SketchCreateToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(SketchCreateToolProvider);
  bind(SketchReadToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(SketchReadToolProvider);
  bind(CompileToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(CompileToolProvider);
  bind(UploadToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(UploadToolProvider);
  bind(SerialMonitorToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(SerialMonitorToolProvider);
  bind(LibraryUninstallToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(LibraryUninstallToolProvider);
  bind(BoardManagerInstallToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(BoardManagerInstallToolProvider);
  bind(FileExplorerToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(FileExplorerToolProvider);
  bind(CodeEditToolProvider).toSelf().inSingletonScope();
  bind(ToolProvider).toService(CodeEditToolProvider);
});
